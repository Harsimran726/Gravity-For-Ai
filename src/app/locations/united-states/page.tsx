      ...
      <div className="w-full flex flex-col">
        <section className="relative min-h-[65vh] flex items-center bg-[#FFFFFF] overflow-hidden py-16 sm:py-24">
          <div className="max-w-[1240px] mx-auto px-6 sm:px-8 lg:px-12 w-full space-y-8">
            ...
            <p className="font-sans text-base sm:text-lg text-[#0A1B3D]/80 max-w-2xl leading-relaxed">
              We build and manage enterprise-grade AI voice agents and agentic automation for US businesses — remotely. Our engineering team is based in India, but our systems speak with natural American English, integrate with US scheduling tools, and operate on US time zones.
            </p>
            <div className="inline-flex items-center gap-2 text-sm text-[#6B7280] font-mono">
              <Wifi className="w-4 h-4 text-[#C99A44]" />
              100% remote delivery — fully managed, no local visit required
            </div>
        ...
        <SectionWrapper variant="warm" id="cities">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-sm sm:text-base text-[#0A1B3D]/80 pt-1">Our AI systems operate across US time zones. All onboarding is done remotely over video calls, and ongoing management is handled asynchronously — no in-person meetings needed.</p>
          </div>
        ...
        <SectionWrapper variant="warm" id="testimonial">
          <div className="max-w-2xl">
            <Card variant="warm" className="space-y-4">
              ...
              <p className="font-sans text-xs sm:text-sm font-medium text-[#122C57]">Marcus T. · <span className="text-[#6B7280]">Commercial Contractor Founder, USA</span></p>
            </Card>
          </div>
        </SectionWrapper>
