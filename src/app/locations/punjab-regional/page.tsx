...
const cities = [
  { name: 'Barnala', desc: 'Retail, FMCG distribution, and agro-trade businesses. AI voice agents handle after-hours inquiries and appointment booking.' },
  { name: 'Amritsar', desc: 'Hospitality, medical centers, and trade enterprises. Trilingual AI (Punjabi, Hindi, English) for diverse clientele.' },
  { name: 'Jalandhar', desc: 'Manufacturing, sports-goods exporters, and clinics. AI manages international time-zone inquiries 24/7.' },
  { name: 'Patiala', desc: 'Educational institutes, legal offices, and healthcare practices. Handles peak admission and enrollment call surges automatically.' },
];
      ...
      <div className="w-full flex flex-col">
        <section className="relative min-h-[65vh] flex items-center bg-[#FFFFFF] overflow-hidden py-16 sm:py-24">
          <div className="max-w-[1240px] mx-auto px-6 sm:px-8 lg:px-12 w-full space-y-8">
            ...
            <div className="inline-flex items-center gap-2 text-sm text-[#6B7280] font-mono">
              ...
              Engineered from Mansa HQ — serving all of Punjab
            </div>
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Button href="/contact" size="lg" variant="primary">Book a Free AI Audit</Button>
              <Button href="/locations/mansa" size="lg" variant="ghost">Visit Our HQ Page →</Button>
            </div>
          </div>
        </section>
        ...
        <SectionWrapper variant="warm" id="cities">
          <div className="max-w-3xl space-y-4">
            <span className="font-mono text-xs uppercase tracking-widest text-[#C99A44]">Areas We Serve</span>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#122C57] font-normal leading-tight">Punjab Districts We Work With</h2>
            <p className="text-sm sm:text-base text-[#0A1B3D]/80 pt-1">Our systems are built remotely and deployed digitally — no office visit required. We operate as a full engineering partner managing your AI systems end-to-end.</p>
          </div>
        ...
        <SectionWrapper variant="white" id="services">
          <div className="max-w-3xl space-y-4">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#122C57] font-normal leading-tight">What We Build for Punjab Businesses</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <Card variant="outline" className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3"><Mic className="w-6 h-6 text-[#122C57]" /><h3 className="font-serif text-2xl text-[#122C57]">AI Voice Agents</h3><p className="text-sm text-[#6B7280]">24/7 call answering in Punjabi, Hindi & English. Books appointments, answers FAQs, and captures leads automatically.</p></div>
            ...
            <Card variant="outline" className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3"><Globe className="w-6 h-6 text-[#122C57]" /><h3 className="font-serif text-2xl text-[#122C57]">Website Development</h3><p className="text-sm text-[#6B7280]">Sub-2s Next.js websites built for local search rankings and discovery call conversion.</p></div>
            ...
            <Card variant="outline" className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3"><Cpu className="w-6 h-6 text-[#122C57]" /><h3 className="font-serif text-2xl text-[#122C57]">Agentic AI Systems</h3><p className="text-sm text-[#6B7280]">Autonomous pipelines that eliminate manual data entry, scheduling friction, and cross-system copy-pasting.</p></div>
        ...
        <SectionWrapper variant="warm" id="testimonial">
          <div className="max-w-2xl">
            <Card variant="warm" className="space-y-4">
              ...
              <p className="font-serif text-base sm:text-lg text-[#0A1B3D] italic leading-relaxed">&ldquo;Having our AI engineering partner based right here in Punjab made all the difference. Our voice agent answers calls fluently in Punjabi and English.&rdquo;</p>
              <p className="font-sans text-xs sm:text-sm font-medium text-[#122C57]">Dr. Raman K. · <span className="text-[#6B7280]">Clinic Founder, Punjab</span></p>
            </Card>
          </div>
        </SectionWrapper>
        ...
        <SectionWrapper variant="black" id="contact" className="py-24 text-center">
          <div className="max-w-2xl mx-auto space-y-6">
            <h2 className="font-serif text-3xl sm:text-5xl text-[#FFFFFF] font-normal leading-tight">Ready to Automate Your Punjab Business?</h2>
            <p className="font-sans text-sm sm:text-base text-[#F7F5F0]/70 max-w-lg mx-auto leading-relaxed">Book a free 20-minute audit call. We will show you exactly how our systems work — and what they can do for your specific business.</p>
