...
const cities = [
  { name: 'Stuttgart', desc: 'Baden-Wuerttemberg Mittelstand, engineering firms, and clinics. AI handles after-hours calls in German and English.' },
  { name: 'Leipzig', desc: 'Logistics, e-commerce, and service businesses. Eliminates routine call volume from core operations.' },
  { name: 'Nuernberg', desc: 'B2B industrial firms, law practices, and medical clinics. GDPR-compliant AI intake pipelines.' },
      ...
      <div className="w-full flex flex-col">
          ...
          <div className="max-w-[1240px] mx-auto px-6 sm:px-8 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-8 z-10">
              ...
              <div className="inline-flex items-center gap-2 text-sm text-[#6B7280] font-mono">
                ...
                <span>100% remote delivery - onboarding and management over video call &amp; digital channels</span>
              </div>
            ...
            <div className="lg:col-span-5 relative flex items-center justify-center lg:justify-end">
              <LocationOperationsCard cityName="Europe" region="DACH Region" />
            </div>
          </div>
        </section>
        ...
        <SectionWrapper variant="warm" id="cities" animate={false}>
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-sm sm:text-base text-[#0A1B3D]/80 pt-1">Our AI systems operate on European schedules. All onboarding is conducted remotely via video call, and ongoing management is handled asynchronously.</p>
          </div>
        ...
        <SectionWrapper variant="white" id="services" animate={false}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <Card variant="outline" className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3"><Mic className="w-6 h-6 text-[#122C57]" /><h3 className="font-serif text-2xl text-[#122C57]">AI Voice Agents</h3><p className="text-sm text-[#6B7280]">AI phone answering in German and English. Answers instantly, qualifies callers, and books appointments 24/7.</p></div>
            ...
            <Card variant="outline" className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3"><Globe className="w-6 h-6 text-[#122C57]" /><h3 className="font-serif text-2xl text-[#122C57]">Website Development</h3><p className="text-sm text-[#6B7280]">High-performance Next.js websites built for Google rankings and lead generation.</p></div>
            ...
            <Card variant="outline" className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-3"><Cpu className="w-6 h-6 text-[#122C57]" /><h3 className="font-serif text-2xl text-[#122C57]">Agentic AI Systems</h3><p className="text-sm text-[#6B7280]">Autonomous pipelines that sync calls, CRM, and calendar data without manual follow-up overhead.</p></div>
        ...
        <SectionWrapper variant="warm" id="testimonial" animate={false}>
          <div className="max-w-2xl">
            <Card variant="warm" className="space-y-4">
              ...
              <p className="font-sans text-xs sm:text-sm font-medium text-[#122C57]">Maximilian W. &middot; <span className="text-[#6B7280]">Geschaeftsfuehrer, Germany</span></p>
            </Card>
          </div>
        </SectionWrapper>
